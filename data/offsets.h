...
/* -------------------------------------------------------------
/*  Dumper Version : version-ed2b47b81f08484a
/*  Cheat Version  : version-5cf2272675e145f5
/* =============================================================
...
namespace Offsets {
    ...
    namespace BasePart {
        ...
        inline constexpr uintptr_t FireTouchInterest = 0x2A806C0;
    ...
    namespace DataModel {
        ...
        inline constexpr uintptr_t ProcessNetworkPacket = 0x31919D0;
        inline constexpr uintptr_t ReportNetworkError = 0xA49200;
        inline constexpr uintptr_t ServerIP = 0x560;
        inline constexpr uintptr_t Workspace = 0x160;
    }

    namespace FakeDataModel {
        inline constexpr uintptr_t Pointer = 0x7DCFA60;
        inline constexpr uintptr_t RealDataModel = 0x1D0;
    }

    namespace GuiBase2D {
        inline constexpr uintptr_t AbsolutePosition = 0xF4;
    ...
    namespace Instance {
        ...
        inline constexpr uintptr_t ConnectionDisconnect = 0x1D0B690;
        inline constexpr uintptr_t HandleConnectionState = 0xA54750;
    ...
    namespace Lighting {
        ...
        inline constexpr uintptr_t ColorShift_Bottom = 0xD4;
        inline constexpr uintptr_t ColorShift_Top = 0xE0;
    ...
    namespace LightingParameters {
        ...
        inline constexpr uintptr_t SkyAmbient2 = 0x184;
    ...
    namespace LocalScript {
        ...
        inline constexpr uintptr_t Hash = 0x98;
    }

    namespace LuaVM {
        inline constexpr uintptr_t Execute = 0x47128F0;
        inline constexpr uintptr_t Load = 0x4706320;
        inline constexpr uintptr_t NamecallAtom = 0x0E6F7E0;
        inline constexpr uintptr_t NewState = 0x46FE430;
        inline constexpr uintptr_t Throw = 0x47003E0;
        inline constexpr uintptr_t Yield = 0x4715E00;
    }
    ...
    namespace ProximityPrompt {
        ...
        inline constexpr uintptr_t FireLeftMouseClick = 0x262F070;
        inline constexpr uintptr_t FireMouseHoverEnter = 0x262F280;
        inline constexpr uintptr_t FireMouseHoverLeave = 0x262F470;
    ...
    namespace ScriptContext {
        inline constexpr uintptr_t GetLuaState = 0x46FE400;
        inline constexpr uintptr_t PushInstance = 0x1CF6FB0;
        inline constexpr uintptr_t Resume = 0x1DD39E0;
    }
    ...
    namespace TaskScheduler {
        inline constexpr uintptr_t Defer = 0x1E47630;
        inline constexpr uintptr_t Delay = 0x1E47A20;
        inline constexpr uintptr_t JobEnd = 0xD0;
        inline constexpr uintptr_t JobName = 0x18;
        inline constexpr uintptr_t JobStart = 0xC8;
        inline constexpr uintptr_t MaxFps = 0xB0;
        inline constexpr uintptr_t Pointer = 0x836AAE8;
        inline constexpr uintptr_t Spawn = 0x1E48510;
        inline constexpr uintptr_t Wait = 0x1E48890;
    }
    ...
    namespace TextButton {
        ...
        inline constexpr uintptr_t ContentText = 0xDD0;
        inline constexpr uintptr_t Font = 0x10E8;
        inline constexpr uintptr_t LineHeight = 0xEC8;
        inline constexpr uintptr_t LocalizedText = 0xDD0;
        inline constexpr uintptr_t MaxVisibleGraphemes = 0x10F4;
        inline constexpr uintptr_t Modal = 0x9C5;
        inline constexpr uintptr_t RichText = 0xFC6;
        inline constexpr uintptr_t Selected = 0x9C6;
        inline constexpr uintptr_t Text = 0xDD0;
        inline constexpr uintptr_t TextColor3 = 0x10D0;
        inline constexpr uintptr_t TextDirection = 0xF68;
        inline constexpr uintptr_t TextScaled = 0xDB9;
        ...
        inline constexpr uintptr_t TextWrapped = 0xFC0;
        inline constexpr uintptr_t TextXAlignment = 0x110C;
        inline constexpr uintptr_t TextYAlignment = 0xF10;
    }

    namespace TextLabel {
        inline constexpr uintptr_t ContentText = 0xB50;
        inline constexpr uintptr_t Font = 0xE68;
        inline constexpr uintptr_t LineHeight = 0xC48;
        inline constexpr uintptr_t LocalizedText = 0xB50;
        inline constexpr uintptr_t MaxVisibleGraphemes = 0xE74;
        inline constexpr uintptr_t RichText = 0xD46;
        ...
        inline constexpr uintptr_t TextWrapped = 0xD40;
        inline constexpr uintptr_t TextXAlignment = 0xE8C;
        inline constexpr uintptr_t TextYAlignment = 0xC90;
    }
